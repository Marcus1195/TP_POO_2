    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <p data-aos="fade-left" data-aos-delay="900"><i class="fa fa-clock-o" aria-hidden="true"></i><span>10:00 am - 11:00 pm</span>
            <i class="fa fa-phone" aria-hidden="true"></i><span>800 1234 5678</span>
          </p>
          <a class="btn btn-success" href="recipes.php" role="button" data-aos="fade-up" data-aos-delay="1000">check our food</a>
        </div>
      </div>
      <!--Row Ended-->
    </div>
    ...
    <div class="container">
      ...
      <div class="row" data-aos="fade-up" data-aos-delay="500">
        ...
        <div class="col-md-6 col-sm-12">
          <div class="row">
            <div class="col-lg-5 col-sm-12">
              <a href="blog_single.php" class="d-block mb-4 h-100">
